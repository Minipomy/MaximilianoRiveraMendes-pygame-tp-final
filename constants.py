...
CLOSE_TEXT= "CLOSE"
SELECT_STAGE_TEXT="Stage Select"
STAGE_1_TEXT= "STAGE 1"
STAGE_2_TEXT= "STAGE 2"
...
BG_SFX = SOUND_PATH + 'PG_INTENSE_MUSIC.mp3'
COLLECT_SFX = SOUND_PATH + 'PG_COLLECTED.mp3'
DEATH_SFX = SOUND_PATH + 'PG_GAME_OVER.mp3'
...
##################### IMAGE CONFIGS #####################
IMAGE_PATH = './Recursos/'
BOSS_RUN = IMAGE_PATH + 'Enemies/Rino/Run (52x34).png'
BOSS_IDLE = IMAGE_PATH + 'Enemies/Rino/Idle (52x34).png'
SAW_ON = IMAGE_PATH + 'Traps/Saw/On (38x38).png'
SAW_OFF = IMAGE_PATH + 'Traps/Saw/Off.png'